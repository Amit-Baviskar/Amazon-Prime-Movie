# :file_folder:Amazon-Prime-Movie:file_folder:
...
# :pushpin: Entry In Table:pushpin:
  **Show Id**	- Distinct Show-id
  **Type** - Describe the Type Of Movie
  **Title**	- Title / Name Of TV Show / Movie
  **Director** - Name Of Director 
  **Cast** - Actor/Actoress Work In Content
  **Country**	- Country 
  **Date_Added** - Date On Which Content Added On Site
  **Release Year** - Date On Which Content Release  From Site
  **Rating** - Average Rating to Content 	
...
# :bar_chart:Dashboard ScreenShort -:bar_chart: 

![AMAZONZ DASh](https://github.com/Amit-Baviskar/Amazon-Prime-Movie/assets/153518736/8eefc895-b625-4873-99ca-e4f808cda7bb)
